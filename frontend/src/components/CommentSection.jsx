        ...
        <div>
            <section>
                <div className="max-w-2xl">
                    <h2 className="text-lg lg:text-2xl font-bold text-gray-900">Comment  </h2>
                    <form>
                        <section className="comment_input rounded-lg border border-gray-400 px-5 py-3 my-5">
                            <textarea id="comment" rows="7"
                                className="w-full text-sm text-gray-900 focus:ring-0 focus:outline-none"
                                placeholder="Write a comment..." required></textarea>
                        </section>
                        <ButtonPrimary text="Post Comment" />
                    </form>
